                    ...
                    <section id="decisions" class="scroll-mt-4">
                        ...
                        <div class="prose prose-sm max-w-none text-foreground space-y-4">
                            ...
                            <ol class="list-decimal pl-6 space-y-2">
                                ...
                                <li>Заполните поля:
                                    <ul class="list-disc pl-6 mt-2">
                                        <li><strong>Название</strong> — название раздела</li>
                            ...
                            <h3 class="text-xl font-semibold mt-6 mb-3">Продукты и Услуги в разделе Решения</h3>
                            <p>
                                Продукты и услуги в разделе "Решения" отличаются от обычных продуктов и услуг. 
                                Они привязаны к конкретным разделам и отображаются в блоке выбора решений.
                            </p>
                            <p><strong>Как добавить продукт/услугу в раздел:</strong></p>
                            <ol class="list-decimal pl-6 space-y-2">
                                <li>Перейдите в "Решения" → "Продукты" или "Услуги"</li>
                                <li>Нажмите "Создать"</li>
                                <li>Выберите раздел, к которому привязан продукт/услуга</li>
                                <li>Заполните остальные поля аналогично обычным продуктам/услугам</li>
                                <li>Нажмите "Сохранить"</li>
                            </ol>
