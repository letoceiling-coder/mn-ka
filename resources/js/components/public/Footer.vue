            ...
            <div class="w-full max-w-[1200px] mx-auto">
                ...
                <div v-if="settings" class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-5">
                    ...
                    <div>
                        ...
                        <!-- Социальные сети -->
                        <div class="flex gap-5 items-center mt-5 mb-3">
                            <!-- VK -->
                            <a 
                                v-if="settings && settings.social_networks && settings.social_networks.vk"
                            ...
                            <!-- Instagram -->
                            <a 
                                v-if="settings && settings.social_networks && settings.social_networks.instagram"
                            ...
                            <!-- Telegram -->
                            <a 
                                v-if="settings && settings.social_networks && settings.social_networks.telegram"
...
export default {
    ...
    setup() {
        ...
        const hasSocialNetworks = computed(() => {
            ...
            return !!(socials.vk || socials.instagram || socials.telegram);
        });
