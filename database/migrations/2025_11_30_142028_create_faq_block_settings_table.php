...
return new class extends Migration
{
    ...
    {
        Schema::create('faq_block_settings', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('faq_items')->nullable()->comment('Массив вопросов и ответов');
    ...
    {
        Schema::dropIfExists('faq_block_settings');
    }
};
