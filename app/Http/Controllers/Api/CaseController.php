...
class CaseController extends Controller
{
    ...
    {
        $query = ProjectCase::with(['image', 'icon', 'services', 'products', 'images', 'chapter'])->ordered();
    ...
    public function show(string $id)
    {
        ...
        if (is_numeric($id)) {
            $case = ProjectCase::with(['image', 'icon', 'services', 'products', 'images', 'chapter'])
                ->find($id);
        } else {
            // Если slug, добавляем префикс "/" если его нет
            $slug = $id;
